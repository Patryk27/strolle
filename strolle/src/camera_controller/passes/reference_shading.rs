...
#[derive(Debug)]
pub struct ReferenceShadingPass {
    pass: CameraComputePass<gpu::ReferencePassParams>,
}

impl ReferenceShadingPass {
        ...
        P: Params,
    {
        let pass = CameraComputePass::builder("reference_shading")
            ...
            .bind([
                ...
                &buffers.reference_rays.bind_writable(),
                &buffers.reference_hits.bind_readable(),
                &buffers.reference_colors.bind_writable(),
            ])
            .build(device, &engine.shaders.reference_shading);
