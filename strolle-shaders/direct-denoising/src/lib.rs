...
pub fn main(
    ...
    #[spirv(descriptor_set = 0, binding = 3)] direct_samples: TexRgba16f,
    #[spirv(descriptor_set = 0, binding = 4)] direct_colors: TexRgba16f,
    #[spirv(descriptor_set = 0, binding = 5)] prev_direct_colors: TexRgba16f,
) {
